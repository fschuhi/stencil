...
- **Templates:** `data/templates.yaml` currently lists one artefact type, `data/LLM_INSTRUCTIONS.md.j2` → `LLM_INSTRUCTIONS.md`. More entries are expected; the schema doesn't need to change to add them.
